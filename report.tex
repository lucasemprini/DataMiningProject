...
\begin{figure}[H]
  \centering
  \adjincludegraphics[width=\linewidth,trim=0 {.04\height} 0 {.3\height},clip]{fig/DecisionTree1.PNG}%
...
\begin{figure}[H]
  \centering
  \adjincludegraphics[width=\linewidth,trim=0 {.04\height} 0 {.3\height},clip]{fig/DecisionTree2.PNG}%
  \caption{Albero di classificazione e output ottenuti con \texttt{J48} \emph{unpruned}}%
  \label{fig:j48}
\end{figure}

\todo[shadow]{Fino a qui}
